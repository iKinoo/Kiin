...
const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="shadow-lg fixed bottom-16 left-1/2 transform -translate-x-1/2 bg-purple-500 rounded-lg flex items-center z-50 md:relative md:bottom-0 md:py-1 md:z-auto">
      <button
