...
const HomeContent: React.FC = () => {
    ...
    return (
      <div className="bg-white text-black h-screen flex flex-col min-h-screen">
        <NavBar links={links} />
        <div className="container mx-auto flex flex-1 items-center justify-center gap-1">
          ...
          <div className="m-1 h-[45vh] w-[45vh] rounded-full border-2 bg-gray-900 img_container">
